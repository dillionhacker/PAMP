...
class Connection(_mysql.connection):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.cursorclass = kwargs2.get('cursorclass', self.default_cursor)
        if 'cursorclass' in kwargs2:
            del kwargs2['cursorclass']
            
        #charset = kwargs2.pop('charset', '')
        charset = kwargs2.get('charset', '')
        if 'charset' in kwargs2:
            del kwargs2['charset']
        ...
        use_unicode = kwargs2.get('use_unicode', use_unicode)
        if 'use_unicode' in kwargs2:
            del kwargs2['use_unicode']
        
        #sql_mode = kwargs2.pop('sql_mode', '')
        sql_mode = kwargs2.get('sql_mode', '')
        if 'sql_mode' in kwargs2:
