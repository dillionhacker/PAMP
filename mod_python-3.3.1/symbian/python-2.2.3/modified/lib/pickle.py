...
# The encode_long/decode_long code below uses string[::-1] for reversing
# a string, which is a feature not available in PyS60, which is based on
# Python 2.2.2. This function does the same. Courtecy of Jukka Laurila.
...
def encode_long(x):
    ...
    # [::-1] not available in PyS60, which is based on 2.2.2.
    # return binary[::-1]
...
def decode_long(data):
    ...
    ashex = _binascii.hexlify(reverse_string(data))
