...
#if HAVE_S60_PATHINFO
#include "s60ext/s60_pathinfo/php_pathinfo.h"
#endif

#if HAVE_S60_CONTACTS
#include "s60ext/s60_contacts/contacts.h"
#endif

#if HAVE_S60_CALENDAR
#include "s60ext/s60_calendar/calendar.h"
#endif

#if HAVE_S60_INBOX
#include "s60ext/s60_inbox/inboxmodule.h"
#endif

#if HAVE_S60_SYSINFO
#include "s60ext/s60_sysinfo/sysinfomodule.h"
#endif

#if HAVE_S60_LOCATION
#include "s60ext/s60_location/php_location.h"
#endif

#if HAVE_S60_LOG
#include "s60ext/s60_log/php_log.h"
#endif
...
#endif
#if HAVE_S60_PATHINFO
	,phpext_s60_pathinfo_ptr
#endif

#if HAVE_S60_CONTACTS
	,phpext_s60_contacts_ptr
#endif

#if HAVE_S60_CALENDAR
	,phpext_s60_calendar_ptr
#endif

#if HAVE_S60_INBOX
	,phpext_s60_inbox_ptr
#endif

#if HAVE_S60_SYSINFO
	,phpext_s60_sysinfo_ptr
#endif

#if HAVE_S60_LOCATION
	,phpext_s60_location_ptr
#endif
