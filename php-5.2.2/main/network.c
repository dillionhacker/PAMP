...
#if defined(PHP_WIN32) || defined(__riscos__) || defined(NETWARE) || defined( __SYMBIAN32__ )
#undef AF_UNIX
#endif
...
# endif
	...
	*sal = safe_emalloc((n + 1), sizeof(*sal), 0);
	...
	if (!inet_aton(host, &in)) {
		...
		#ifdef __SYMBIAN32__
		host_info = gethostbyname_iap(host);
		#else
...
#ifdef __SYMBIAN32__
#undef HAVE_NON_BLOCKING_CONNECT
#endif
...
#if HAVE_GETTIMEOFDAY & !defined(__SYMBIAN32__)
			if (timeout) {
