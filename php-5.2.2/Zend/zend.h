...
#if (HAVE_ALLOCA || (defined (__GNUC__) && __GNUC__ >= 2)) && !(defined(ZTS) && defined(ZEND_WIN32)) && !(defined(ZTS) && defined(NETWARE)) && !(defined(ZTS) && defined(HPUX)) && !defined(DARWIN) && !defined( __SYMBIAN32__ )
...
#if defined(__GNUC__)
#define zend_reinterpret_cast(A) reinterpret_cast<A>
#define zend_const_cast(A) const_cast<A>
#elif !defined(zend_reinterpret_cast)
#define zend_reinterpret_cast(A) (A)
#define zend_const_cast(A) (A)
#endif
...
typedef struct _zend_utility_functions {
	...
	int (*get_configuration_directive)(char *nam, uint name_length, zval *contents);
