 ...
 */
APU_DECLARE_EXPORTED_DATA(const apr_bucket_type_t, apr_bucket_type_flush);
 ...
 * bucket of this type
 */
APU_DECLARE_EXPORTED_DATA(const apr_bucket_type_t, apr_bucket_type_eos);

/**
 * The FILE bucket type.  This bucket represents a file on disk
 */
APU_DECLARE_EXPORTED_DATA(const apr_bucket_type_t, apr_bucket_type_file);

/**
 * The HEAP bucket type.  This bucket represents a data allocated from the
 * heap.
 */
APU_DECLARE_EXPORTED_DATA(const apr_bucket_type_t, apr_bucket_type_heap);

#if APR_HAS_MMAP
/**
 * The MMAP bucket type.  This bucket represents an MMAP'ed file
 */
APU_DECLARE_EXPORTED_DATA(const apr_bucket_type_t, apr_bucket_type_mmap);
#endif
 ...
 */
APU_DECLARE_EXPORTED_DATA(const apr_bucket_type_t, apr_bucket_type_pool);

/**
 * The PIPE bucket type.  This bucket represents a pipe to another program.
 */
APU_DECLARE_EXPORTED_DATA(const apr_bucket_type_t, apr_bucket_type_pipe);
 ...
 */
APU_DECLARE_EXPORTED_DATA(const apr_bucket_type_t, apr_bucket_type_immortal);
 ...
 * to the heap
 */
APU_DECLARE_EXPORTED_DATA(const apr_bucket_type_t, apr_bucket_type_transient);

/**
 * The SOCKET bucket type.  This bucket represents a socket to another machine
 */
APU_DECLARE_EXPORTED_DATA(const apr_bucket_type_t, apr_bucket_type_socket);
