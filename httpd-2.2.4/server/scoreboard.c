...
AP_DEFINE_EXPORTED_DATA(scoreboard *, ap_scoreboard_image) = NULL;
AP_DEFINE_EXPORTED_DATA(const char *, ap_scoreboard_fname) = NULL;
AP_DEFINE_EXPORTED_DATA(int, ap_extended_status) = 0;
