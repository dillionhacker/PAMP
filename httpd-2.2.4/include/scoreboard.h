...
AP_DECLARE_EXPORTED_DATA(scoreboard *, ap_scoreboard_image);
AP_DECLARE_EXPORTED_DATA(const char *, ap_scoreboard_fname);
AP_DECLARE_EXPORTED_DATA(int, ap_extended_status);

AP_DECLARE_EXPORTED_DATA(ap_generation_t volatile, ap_my_generation);
