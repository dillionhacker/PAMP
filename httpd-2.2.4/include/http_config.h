...
# define AP_INIT_RAW_ARGS(directive, func, mconfig, where, help) \
    { directive, (cmd_func) func, mconfig, where, RAW_ARGS, help }
# define AP_INIT_TAKE_ARGV(directive, func, mconfig, where, help) \
    { directive, (cmd_func) func, mconfig, where, TAKE_ARGV, help }
# define AP_INIT_TAKE1(directive, func, mconfig, where, help) \
 ...
 */
AP_DECLARE_EXPORTED_DATA(module *, ap_top_module);

/**
 * Array of all statically linked modules
 * @defvar module *ap_prelinked_modules[]
 */
AP_DECLARE_EXPORTED_DATA_ARRAY(module *, ap_prelinked_modules, []);
/**
 * Array of all statically linked modulenames (symbols)
 * @defvar ap_module_symbol_t ap_prelinked_modulenames[]
 */
AP_DECLARE_EXPORTED_DATA_ARRAY(ap_module_symbol_t, ap_prelinked_module_symbols, []);
/**
 * Array of all preloaded modules
 * @defvar module *ap_preloaded_modules[]
 */
AP_DECLARE_EXPORTED_DATA_ARRAY(module *, ap_preloaded_modules, []);
/**
 * Array of all loaded modules
 * @defvar module **ap_loaded_modules
 */
AP_DECLARE_EXPORTED_DATA(module **, ap_loaded_modules);
