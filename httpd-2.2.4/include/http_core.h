 ...
 */
AP_DECLARE_EXPORTED_DATA(module, core_module);
 ...
 * turned off.
 */
extern int ap_always_use_blocking_io;
#endif
...
AP_DECLARE_EXPORTED_DATA(ap_filter_rec_t *, ap_subreq_core_filter_handle);
AP_DECLARE_EXPORTED_DATA(ap_filter_rec_t *, ap_core_output_filter_handle);
AP_DECLARE_EXPORTED_DATA(ap_filter_rec_t *, ap_content_length_filter_handle);
AP_DECLARE_EXPORTED_DATA(ap_filter_rec_t *, ap_core_input_filter_handle);
