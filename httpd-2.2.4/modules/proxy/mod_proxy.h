...
#if defined(PROXY_DECLARE_EXPORT)
#define PROXY_DECLARE(type)            EXPORT_C type
#define PROXY_DECLARE_NONSTD(type)     EXPORT_C type
#define PROXY_DECLARE_DATA
#else
#define PROXY_DECLARE(type)            IMPORT_C type
#define PROXY_DECLARE_NONSTD(type)     IMPORT_C type
#define PROXY_DECLARE_DATA
#endif
...
#if defined(__SYMBIAN32__)
PROXY_DECLARE(int) ap_proxy_is_hostname_iap(const char* iap, 
                                            struct dirconn_entry *This, apr_pool_t *p);
#endif
...
/* For proxy_util */
#if !defined(__SYMBIAN32__) || defined(PROXY_DECLARE_EXPORT)
...
#if !defined(PROXY_DECLARE_EXPORT)
#define proxy_module (*_proxy_module())
#endif
#endif
