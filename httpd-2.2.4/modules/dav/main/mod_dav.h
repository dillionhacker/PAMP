...
#if defined(DAV_DECLARE_EXPORT)
#define DAV_DECLARE(type)        EXPORT_C type
#define DAV_DECLARE_NONSTD(type) EXPORT_C type
#else
#define DAV_DECLARE(type)        IMPORT_C type
#define DAV_DECLARE_NONSTD(type) IMPORT_C type
#endif
